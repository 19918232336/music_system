  ...
  <div class="message">
    <el-card class="message-content">
      ...
      <div class="btn-group">
        ...
        <el-button type="success" @click="release" plain>发布</el-button>
      </div>
      <el-divider></el-divider>
      <!--评论区-->
        ...
        <div v-for="item in messageList" class="message-item">
          ...
          <div class="child-message" v-if="item.children.length>0">
            <div class="child-message-item" v-for="item1 in item.children">
              ...
              <div class="message-item-right">
                <div class="message-item-name">
                  {{ item1.userInfo.username }}
                  <el-tag v-if="item1.userInfo.permissions" type="success" style="margin-left: 30px;">管理员</el-tag>
                </div>
